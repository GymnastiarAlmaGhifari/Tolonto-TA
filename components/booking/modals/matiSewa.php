...
<section>
    <div id="modal_overlay_mati_sewa" class="hidden absolute inset-0 bg-black bg-opacity-30 h-screen w-full flex justify-center items-center pt-10 md:pt-0 z-50">
        ...
        <svg width="57" height="60" class="mx-auto" viewBox="0 0 57 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 class="mx-auto text-center xs:px-5 sm:px-0 text-neutral_900">Apakah anda benar ingin menonaktifkan sewa dengan ID </h2>
            ...
            <form id="matiSewa" action="matiSewa.php" method="post" class="flex flex-col items-center justify-center gap-2 mt-2" enctype="multipart/form-data">
                <div class="flex flex-row xs:gap-6 md:gap-[42px] mt-2 items-center justify-center w-full">
                    <button type="button" title="batal" onclick="openModalMatiSewa(false)" name="Batal-Delete-Admin" id="Batal-Delete-Admin" value="Batal-Delete-Admin" class="bg-neutral_050 hover:bg-neutral_200 focus:bg-neutral_400 text-neutral_900 border border-neutral_600 w-5/12 h-12 rounded-2xl shadow-elevation-light-2">
                        Batal
                    </button>
                    <button type="submit" title="konfirmasi nonaktifkan sewa" name="Konfirmasi-mati" id="Konfirmasi-mati" class="bg-error_600 text-neutral_050 w-5/12 h-12 rounded-2xl shadow-elevation-light-2 hover:bg-error_300 focus:bg-error_800"">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
