    ...
    <div id="modal_overlay_sewa" class="hidden absolute inset-0 bg-black bg-opacity-30 h-screen w-full flex justify-center items-center pt-10 md:pt-0 z-50">
        ...
        <div id="modal_sewa" class="opacity-0 transform -translate-y-full scale-150  relative bg-neutral_800 h-[578px]  xs:w-[345px] sm:w-[500px] rounded-2xl flex flex-col justify-center gap-4 transition-opacity transition-transform duration-300">
            <div class="flex flex-row justify-between items-center -mt-6">
                ...
                <button onclick="openModalSewa(false)" class="bg-neutral_050 hover:bg-neutral_200 focus:bg-neutral_400 w-[30px] h-[30px] rounded-full mr-6 relative">
            ...
            <div class="flex flex-row xs:gap-6 md:gap-[42px]  justify-center items-center w-full">
                ...
                <div class="flex flex-row xs:gap-6 md:gap-[42px] items-center justify-center w-full">
                    <a href="https://maps.google.com/?q=-7.154825,111.875869" title="lihat lokasi customer" type="button" target="_blank" name="map" id="map" class="bg-error_600 text-neutral_050  w-5/12 h-12 rounded-2xl flex flex-row gap-3 justify-center items-center shadow-elevation-light-2 hover:bg-error_300 focus:bg-error_800"">
                        ...
                        <h1 class="hidden sm:block">Lokasi Customer</h1>
                        <h1 class="hidden xs:block sm:hidden">Lokasi</h1>
                    </a>
                    <a href="https://wa.me/620895387390033/?text-Hello" title="hubungi customer" type="button" target="_blank" name="whatsapp" id="whatsapp" class="bg-[#4FCF2F] text-neutral_050 shadow-elevation-light-2  hover:bg-[#81FF62] focus:bg-[#4FCF2F]/80 w-5/12 h-12 rounded-2xl flex flex-row gap-3 justify-center items-center">
                        ...
                        <h1 class="hidden sm:block">WhatsApp Customer</h1>
                        <h1 class=" hidden xs:block sm:hidden">WhatsApp</h1>
                    </a>
                </div>
        </div>
        </form>
