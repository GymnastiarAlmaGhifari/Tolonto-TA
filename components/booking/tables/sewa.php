                        ...
                        <div class="flex flex-wrap flex-col ">
                            <div class=" flex flex-row justify-between items-center -mb-3">
                                <div class="flex items-center justify-center gap-4">
                                    <h1 class="capitalize font-semibold xs:text-sm sm:text-base">Sewa Aktif dan Pending</h1>
                                    <h2><?php echo $jumlah_sewa ?></h2>
                                </div>
                                <span title="buka/tutup table sewa" id="open2" class="w-[36px] h-[36px] bg-neutral_050 hover:bg-neutral_050/90 focus:bg-neutral_050/75 rounded-full flex items-center justify-center cursor-pointer -mr-2">
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="pl-4  text-center">
                                                        <div class="h-[36px] w-[91px] bg-neutral_050 rounded-full p-2 flex flex-row items-center justify-center mx-auto gap-2 ">
                                                            <button id="info_sewa" title="info sewa" name="info_sewa" type="submit" value="<?php echo $sewa[$rows]['id_sewa'] ?>" class=" hover:bg-neutral_900/20  w-[35px] h-[28px] rounded-3xl">
                                                            ...
                                                            <button id="aktif_sewa" title="aktifkan sewa" value="<?php echo $sewa[$rows]['id_sewa'] ?>" class="hover:bg-neutral_900/20 w-[35px] h-[28px] rounded-3xl">
                                                        ...
                                                        <?php } else if ($sewa[$rows]['status'] == 'aktif') { ?>
                                                            ...
                                                            <span class="w-0.5 h-6 bg-neutral_900"></span>
                                                            <button id="mati_sewa" title="nonaktifkan sewa" class="hover:bg-neutral_900/20 w-[35px] h-[28px] rounded-3xl" value="<?php echo $sewa[$rows]['id_sewa'] ?>">
                                                                <svg width="19" class="mx-auto" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
