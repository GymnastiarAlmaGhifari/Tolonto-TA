    ...
    <div class="container">
        <div class="flex flex-wrap gap-7 flex-row">
                    ...
                    <div class=" xs:w-[260px] sm:w-[350px] h-[230px] bg-neutral_800 rounded-xl shadow-elevation-dark-4 flex flex-col">
                        <div class="flex justify-between mt-2 mx-5">
                            ...
                            <div class="flex flex-row gap-2">
                                <button id="editRental" name="editRental" value="<?php echo $ps[$row]['id_ps'] ?>" class="w-[30px] h-[30px] bg-neutral_050  rounded-full relative hover:bg-neutral_050/90 focus:bg-neutral_050/75">
                                ...
                                <button id="hapusRental" name="hapusRental" value="<?php echo $ps[$row]['id_ps'] ?>" class=" w-[30px] h-[30px] bg-neutral_050 rounded-full relative hover:bg-neutral_050/90 focus:bg-neutral_050/75">
            ...
            <div class="xs:w-[260px] sm:w-[350px] h-[230px] bg-transparent rounded-xl  flex items-center justify-center">
                <button id="tambahRental" name="tambahRental" class="flex justify-center items-center h-[150px] w-[150px] shadow-elevation-dark-4 bg-neutral_800 rounded-full relative hover:bg-neutral_700 focus:bg-neutral_900">
