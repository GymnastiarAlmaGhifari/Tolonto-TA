    ...
    <div class="container">
        <div class="flex flex-wrap gap-7 flex-row">
                    ...
                    <div class="w-[350px] h-[230px] bg-neutral_800 rounded-xl shadow-elevation-dark-4 flex flex-col">
                        <div class="flex justify-between mt-2 mx-5">
                            ...
                            <div class="flex flex-row gap-2">
                                <button title="edit ps sewa" id="editSewa" name="editSewa" value="<?php echo $ps_sewa[$row]['id_ps'] ?>" class="w-[30px] h-[30px] bg-neutral_050  rounded-full relative">
                                ...
                                <button title="hapus ps sewa" id="hapusSewa" name="hapusSewa" value="<?php echo $ps_sewa[$row]['id_ps'] ?>" class=" w-[30px] h-[30px] bg-neutral_050 rounded-full relative">
            ...
            <div class="w-[350px] h-[230px] bg-transparent rounded-xl  flex items-center justify-center relative">
                <button title="tambah ps sewa" id="tambahSewa" name="tambahSewa" class="flex justify-center items-center h-[150px] w-[150px] shadow-elevation-dark-4 bg-neutral_800 rounded-full ">
