        ...
        <div id="modal_rental_edit" class="opacity-0 transform -translate-y-full scale-150  relative bg-neutral_800 h-[520px] xs:w-[345px] sm:w-[500px] rounded-2xl flex flex-col justify-center gap-4 transition-opacity transition-transform duration-300">
            ...
            <form action="inventory.php" method="post" class="flex flex-col items-center justify-center gap-4 mt-2" enctype="multipart/form-data">
                ...
                <div class="relative z-0 w-11/12 mt-5">
                    <input type="text" id="nama-ps-rental-edit" name="nama-ps-rental-edit" required class="block py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl focus:pt-5 valid:pt-5 pl-16 valid:text-neutral_900 peer" placeholder=" " />
                ...
                <div class="relative z-0 w-11/12">
                    <input type="text" id="harga-ps-rental-edit" name="harga-ps-rental-edit" required class="block py-2.5 text-base text-neutral_900 valid:text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl focus:pt-5 valid:pt-5 pl-16 peer" placeholder=" " />
                    <label for="harga-ps-rental-edit" class="absolute text-base text-neutral_900  duration-300 transform -translate-y-3 scale-75 top-4 z-10 origin-[0] left-16 peer-focus:left-16 peer-valid:text-neutral_900 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 peer-focus:text-sm peer-valid:text-sm">Harga PS</label>
                ...
                <div class="flex flex-row xs:gap-6 md:gap-[42px] mt-2 items-center justify-center w-full">
                    <button title="batal" type="button" onclick="openModalRentalEdit(false)" name="batal-rental-edit" id="batal-rental-edit" value="batal-rental-edit" class="bg-error_600 text-neutral_050 w-5/12 h-12 rounded-2xl px-4 shadow-elevation-light-2 hover:bg-error_300 focus:bg-error_800">
                        Batal
                    </button>
                    <button title="konfirmasi edit ps rental" type="submit" name="Konfirmasi-rental-edit" id="Konfirmasi-rental-edit" class="bg-[#4FCF2F] text-neutral_050 w-5/12 h-12 rounded-2xl px-4 shadow-elevation-light-2  hover:bg-[#81FF62] focus:bg-[#4FCF2F]/80">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
