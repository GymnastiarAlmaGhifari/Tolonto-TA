     ...
     <div id="modal_overlay_sewa" class="hidden absolute inset-0 bg-black bg-opacity-30 h-screen w-full flex justify-center items-center pt-10 md:pt-0 z-50">
         ...
         <div id="modal_sewa" class="opacity-0 transform -translate-y-full scale-150  relative bg-neutral_800 h-[520px] xs:w-[345px] sm:w-[500px] rounded-2xl flex flex-col justify-center gap-4 transition-opacity transition-transform duration-300">
             <div class="flex flex-row justify-start ml-[25px]  gap-3 mb-3">
                 ...
                 <h1 id="mdoalText" class="text-neutral_050 font-base font-noto-sans xs:text-base sm:text-xl">Tambah PlayStation Sewa Baru</h1>
             </div>
             ...
             <form action="inventory.php" method="post" class="flex flex-col items-center justify-center gap-4 mt-2" enctype="multipart/form-data">
                 ...
                 <div class="relative z-0 w-11/12 mt-5">
                     <input type="text" id="nama-ps-sewa" name="nama-ps-sewa" required class="block py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl focus:pt-5 valid:pt-5 pl-16 valid:text-neutral_900 peer" placeholder=" " />
 ...
 <script>
     ...
     const harga_sewa = document.getElementById('harga-ps-sewa');
