                    ...
                    <div class="w-[350px] h-[230px] bg-neutral_800 rounded-xl shadow-elevation-dark-4 flex flex-col">
                        <div class="flex justify-between mt-2 mx-5">
                            ...
                            <div class="flex flex-row gap-2">
                                <button id="editSewa" name="editSewa" value="<?php echo $ps_sewa[$row]['id_ps'] ?>" class="w-[30px] h-[30px] bg-neutral_050  rounded-full relative">
                                ...
                                <button id="hapusSewa" name="hapusSewa" value="<?php echo $ps_sewa[$row]['id_ps'] ?>" class=" w-[30px] h-[30px] bg-neutral_050 rounded-full relative">
...
<?php require_once 'components/inventorysuper/modals/edit-sewa.php' ?>
<?php require_once 'components/inventorysuper/modals/hapus-sewa.php' ?>