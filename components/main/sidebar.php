                ...
                <li>
                    <button id="dashboard" name="dashboard" type="submit" class="w-full">
                        <div id="bungkus" class="flex flex-row justify-center items-center gap-8 h-full w-[50px] ml-[5px]  py-3 hover:bg-primary_600 rounded-2xl focus:bg-neutral_800 <?php echo $active ?>">
                            <svg id="svg" class="" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    <button id="booking" name="booking" type="submit" class="w-full">
                        <div id="bungkus" class="flex flex-row justify-center items-center gap-8 h-full w-[50px] ml-[5px]  py-3 hover:bg-primary_600 rounded-2xl focus:bg-neutral_800 <?php echo $active3 ?>">
                            <svg id="svg" class="mt-1" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
