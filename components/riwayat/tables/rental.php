             ...
             <div class="flex flex-wrap flex-col ">
                 <div class=" flex flex-row justify-between items-center -mb-3">
                     ...
                     <div class="flex flex-row gap-2 sm:gap-5">
                         <button id="hapus-semua-rental" class="h-[36px] bg-neutral_050 hover:bg-neutral_050/90 focus:bg-neutral_050/75 rounded-full p-4 flex flex-row items-center justify-center mx-auto gap-3">
                                     ...
                                     <tr class="">
                                         ...
                                         <td class="pl-4  text-center"><?php list($date, $time) = explode(" ", $rent[$row]['mulai_rental']);
                                             ...
                                             - <?php list($date, $time) = explode(" ", $rent[$row]['selesai_rental']);
                                                echo $time; ?></td>
                                         <td class="pl-10 text-left">Rp. <?php echo $rent[$row]['bayar'] ?></td>
                                         <td class="pl-4  text-center">
                                             <button id="hapus-rental" value="<?php echo $topup[$row]['id_topup'] ?>" class="h-[36px] bg-neutral_050 rounded-full p-4 flex flex-row items-center justify-center mx-auto gap-2">
