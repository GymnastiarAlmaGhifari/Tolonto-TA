                                ...
                                while ($rows < count($service)) { ?>
                                    <tr class="">
                                        ...
                                        <td class="pl-4  text-center">
                                            <button id="hapus-servis" value="<?php echo $service[$rows]['id_servis'] ?>" class="h-[36px] bg-neutral_050 rounded-full p-4 flex flex-row items-center justify-center mx-auto gap-2">
