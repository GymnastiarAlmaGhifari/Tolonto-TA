            ...
            <div class="flex flex-wrap flex-col ">
                <div class=" flex flex-row justify-between items-center -mb-3">
                    ...
                    <div class="flex flex-row gap-2 sm:gap-5">
                        <button id="hapus-semua-servis" class="h-[36px] bg-neutral_050 rounded-full p-4 flex flex-row items-center justify-center mx-auto gap-3">
                        ...
                        <span id="open4" class="w-[36px] h-[36px] bg-neutral_050 rounded-full flex items-center justify-center cursor-pointer -mr-2">
