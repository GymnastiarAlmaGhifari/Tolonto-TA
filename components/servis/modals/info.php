        ...
        <div id="modal_info" class="opacity-0 transform -translate-y-full scale-150  relative bg-neutral_800 h-[520px] xs:w-[345px] sm:w-[500px] rounded-2xl flex flex-col justify-center gap-4 transition-opacity transition-transform duration-300">
            ...
            <form action="servisSuperAdmin.php" method="post" class="flex flex-col items-center justify-center gap-4 -mt-2" enctype="multipart/form-data">
                ...
                <div class="flex flex-row gap-[42px] items-center justify-center w-full">
                    ...
                    <a href="https://wa.me/620895387390033/?text-Hello" type="button" target="_blank" name="whatsapp" id="whatsapp" class="bg-[#4FCF2F] text-neutral_050 shadow-elevation-light-2 w-11/12 h-12 rounded-2xl flex flex-row gap-3 justify-center items-center">
