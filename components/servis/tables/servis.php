        ...
        <div id="atas" class="bg-neutral_800 rounded-xl shadow-elevation-dark-4 px-8 duration-300 ease-in-out relative pt-5">
            <div class="flex flex-wrap flex-col ">
                <div class=" flex flex-row justify-between items-center -mb-3">
                    ...
                    <span id="open" title="buka/tutup table servis" class="w-[36px] h-[36px] bg-neutral_050 hover:bg-neutral_050/90 focus:bg-neutral_050/75 rounded-full flex items-center justify-center cursor-pointer -mr-2">
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="pl-4  text-center">
                                            <div class="h-[36px] w-[91px] bg-neutral_050 rounded-full p-2 flex flex-row items-center justify-center mx-auto gap-2 ">
                                                <button id="infoServis" title="info servis" name="infoServis" type="submit" value="<?php echo $service[$rows]['id_servis'] ?>" class=" hover:bg-neutral_900/20  w-[35px] h-[28px] rounded-3xl">
                                                ...
                                                <button id="editServis" title="edit servis" value="<?php echo $service[$rows]['id_servis'] ?>" class="hover:bg-neutral_900/20 w-[35px] h-[28px] rounded-3xl">
