    ...
    <div id="modal_overlay_edit" class="hidden absolute inset-0 bg-black bg-opacity-30 h-screen w-full flex justify-center items-start md:items-center pt-10 md:pt-0 z-50">
        ...
        <div id="modal_edit" class="opacity-0 transform -translate-y-full scale-150  relative bg-neutral_800 h-[575px] w-[500px] rounded-2xl flex flex-col justify-center gap-4 transition-opacity transition-transform duration-300">
            ...
            <form action="servisSuperAdmin.php" method="post" class="flex flex-col items-center justify-center gap-4 -mt-2" enctype="multipart/form-data">
                ...
                <div class="flex flex-row w-full items-center justify-center gap-[42px]">
                    <div class="relative z-0 w-5/12 ">
                        <h1 class="text-neutral_050 font-medium mb-2 ml-3">Status</h1>
                        <svg width="14" height="24" class="absolute top-12  left-5" viewBox="0 0 13 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="relative z-0 w-5/12">
                        <h1 class="text-neutral_050 font-medium mb-2 ml-3">Status</h1>
                        <input type="text" id="bayar" name="bayar" required class="block py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl focus:pt-5 valid:pt-5 pl-14 peer" placeholder=" " />
                        <label for="bayar" class="absolute text-base text-neutral_900  duration-300 transform -translate-y-3 scale-75 top-12 z-10 origin-[0] left-14 peer-focus:left-16 peer-focus:text-neutral_500 peer-valid:text-neutral_500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 peer-focus:text-sm peer-valid:text-sm">Harga PS</label>
                        <svg width="14" height="24" class="absolute top-12 left-5" viewBox="0 0 14 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="submit" name="edit_konfirmasi" id="edit_konfirmasi" class="bg-[#4FCF2F] text-neutral_050 shadow-elevation-light-2 w-11/12 h-[58px] rounded-2xl flex flex-row gap-3 justify-center items-center mt-2">
