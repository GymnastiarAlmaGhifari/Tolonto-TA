...
<div class="container">
    <div class="flex flex-wrap ">
        <div id="sidebar" class="w-[50px] bg-primary_500 z-40 h-screen fixed text-neutral_900 font-noto-sans duration-300">
            <div id="flexing" class="">
                ...
                <img src="https://melmagazine.com/wp-content/uploads/2021/01/66f-1.jpg" id="gambar" width="80px" height="80px" alt="" class="hidden">
                <h1 id="text" class="font-semibold my-auto hidden text-base">Tolonto</h1>
            </div>
            <ul class="mt-20 flex flex-col gap-8">
                <li>
                    <button id="dashboard" name="dashboard" type="submit" class="flex flex-row justify-evenly py-5 hover:bg-secondary_100 w-full">
                        ...
                        <h1 id="text" class="font-medium my-auto hidden">Dashboard</h1>
                    </button>
                </li>
                <li>
                    <button id="inventory" name="inventory" type="submit" class="flex flex-row justify-evenly py-5 hover:bg-secondary_100 w-full">
                        ...
                        <h1 id="text" class="font-medium my-auto hidden">Inventory</h1>
                    </button>
                </li>
                <li>
                    <button id="booking" name="booking" type="submit" class="flex flex-row justify-evenly py-5 hover:bg-secondary_100 w-full">
                        ...
                        <h1 id="text" class="font-medium my-auto hidden">Booking</h1>
                    </button>
                </li>
                <li>
                    <button id="servis" name="servis" type="submit" class="flex flex-row justify-evenly py-5 hover:bg-secondary_100 w-full">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 id="text" class="font-medium my-auto hidden">Services</h1>
                    </button>
                </li>
                <li>
                    <button id="history" name="history" type="submit" class="flex flex-row justify-evenly py-5 hover:bg-secondary_100 w-full">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 id="text" class="font-medium my-auto hidden">History</h1>
                    </button>
                </li>
                <li>
                    <button id="user" name="user" type="submit" class="flex flex-row justify-evenly py-5 hover:bg-secondary_100 w-full">
                        ...
                        <h1 id="text" class="font-medium my-auto hidden">Users</h1>
                    </button>
                </li>
            </ul>
        </div>
