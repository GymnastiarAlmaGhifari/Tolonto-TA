...
<section>
    <div id="modal_overlay_editadmin" class="hidden absolute inset-0 bg-black bg-opacity-30 h-screen w-full flex justify-center items-center pt-10 md:pt-0 z-50">
        <!-- modal -->
        <div id="modal_editadmin" class="opacity-0 transform -translate-y-full scale-150  relative bg-neutral_800 h-[520px] xs:w-[345px] sm:w-[500px] rounded-2xl flex flex-col justify-center gap-4 transition-opacity transition-transform duration-300">
            ...
            <form action="user.php" method="post" class="flex flex-col items-center justify-center gap-4 mt-2" enctype="multipart/form-data">
                ...
                <div class="flex flex-col justify-center items-center relative">
                    ...
                    <img src="components/kamera.png" alt="" name="preview-Admin-Edit" id="preview-Admin-Edit" class="w-[100px] h-[100px] object-cover rounded-full shadow-elevation-dark-4 bg-transparent">
                    <label>
                ...
                <div class="relative z-0 w-11/12">
                    <input type="password" id="password-edit" name="password-edit" class="block py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl focus:pt-5 valid:pt-5 pl-16 peer" placeholder=" " />
                ...
                <div class="flex flex-row xs:gap-6 md:gap-[42px]  justify-center items-center w-full ">
                    <div class="relative z-0 w-5/12 ">
                        ...
                        <select name="level-edit" id="level-edit" required class="select select-bordered font-normal py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl  xs:pl-12 md:pl-16  pr-3 outline-none">
                    ...
                    <div class="relative z-0 w-5/12 ">
                        ...
                        <select name="lokasi-edit" id="lokasi-edit" required class="select select-bordered font-normal py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl xs:pl-12 md:pl-16  pr-3 outline-none">
                ...
                <div class="flex flex-row xs:gap-6 md:gap-[42px] mt-2 items-center justify-center w-full">
                    <button type="button" title="batal" onclick="openModalEditadmin(false)" name="Batal-Admin-Edit" id="Batal-Admin-Edit" value="Batal-Admin-Edit" class="bg-error_600 text-neutral_050 w-5/12 h-12 rounded-2xl shadow-elevation-light-2 hover:bg-error_300 focus:bg-error_800"">
                        Batal
                    </button>
                    <button type="submit" title="konfirmasi edit admin" name="Konfirmasi-Admin-Edit" id="Konfirmasi-Admin-Edit" class="bg-[#4FCF2F] text-neutral_050 w-5/12 h-12 rounded-2xl shadow-elevation-light-2  hover:bg-[#81FF62] focus:bg-[#4FCF2F]/80">Konfirmasi</button>
                </div>
            </form>
        </div>
    </div>
