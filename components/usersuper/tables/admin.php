                                ...
                                <tr class="">
                                    ...
                                    <td class=" text-center">
                                        <div class="h-[36px] w-[91px] bg-neutral_050 rounded-full p-2 flex flex-row items-center justify-center mx-auto gap-2 ">
                                            <button id="editAdmin" name="editAdmin" type="submit" value="<?php echo $tb_admin[$row]['id_admin'] ?>" class=" hover:bg-neutral_900/20  w-[35px] h-[28px] rounded-3xl relative">
                                            ...
                                            <button id="deleteAdmin" value="<?php echo $tb_admin[$row]['id_admin'] ?>" class="hover:bg-neutral_900/20 w-[35px] h-[28px] rounded-3xl relative">
