...
<body>
    ...
    <main class=" bg-neutral_900 w-full font-noto-sans">
        <div class="overflow-x-hidden overflow-y-auto font-noto-sans h-screen">
            ...
            <div id="modal-tambah" class="fixed bg-black/50 h-screen hidden justify-center items-center w-screen z-50">

                <div class="bg-neutral_800 h-[520px] w-[500px] rounded-2xl flex flex-col justify-center gap-4">
                    <div class="flex flex-row justify-start ml-[23px]  gap-3 mb-3">
                        ...
                        <h1 class="text-neutral_050 font-base font-noto-sans text-xl">Tambah PlayStation Baru</h1>
                    </div>
                    ...
                    <form action="inventorySuperAdmin.php" method="post" class="flex flex-col items-center justify-center gap-4 mt-2">
                        ...
                        <div class="flex flex-col justify-center items-center relative">
                            ...
                            <label>
                                <input class="text-sm cursor-pointer w-36 hidden" type="file" name="image" id="image" />
                        ...
                        <div class="relative z-0 w-11/12 mt-5">
                            <input type="text" id="nama-ps" name="nama-ps" class="block py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl focus:pt-5 valid:pt-5 pl-16 peer" placeholder=" " />
                        ...
                        <div class="relative z-0 w-11/12">
                            <input type="text" id="harga-ps" name="harga-ps" class="block py-2.5 text-base text-neutral_900 bg-neutral_050 w-full h-14 rounded-2xl focus:pt-5 valid:pt-5 pl-16 peer" placeholder=" " />
                        ...
                        <div class="flex flex-row gap-11 items-center justify-center w-full">
                            <button type="button" name="Batal" id="Batal" value="Batal" class="bg-error_600 text-neutral_050 w-5/12 h-12 rounded-2xl px-4">
                                Batal
                            </button>
                            <input type="submit" name="Konfirmasi" id="Konfirmasi" value="Konfirmasi" class="bg-[#4FCF2F] text-neutral_050 w-5/12 h-12 rounded-2xl px-4">
                        </div>
                    </form>
                </div>
                ...
                <div class="container">
                    <div class="flex flex-wrap gap-7 flex-row">
                        ...
                        <div class="w-[350px] h-[230px] bg-transparent rounded-xl  flex items-center justify-center">
                            <button id="tambah" name="tambahButton" onclick="tambah()" class="flex justify-center items-center h-[150px] w-[150px] shadow-elevation-dark-4 bg-neutral_800 rounded-full relative">
    ...
    <script>
        ...
        const modal_tambah = document.getElementById('modal-tambah');
        const batal = document.getElementById('Batal');


        tambahButton.addEventListener('click', () => {
            modal_tambah.classList.toggle('activeModal');
        });
