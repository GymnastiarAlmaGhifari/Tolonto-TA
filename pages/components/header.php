...
<div class="w-screen h-[60px] fixed z-50 bg-primary_500 flex items-center  justify-between pr-20 ml-12">
    <h1 class="font-noto-sans text-lg text-neutral_900 ml-[46px] font-semibold">Dashboard</h1>
    <div class="flex items-center xs:gap-x-5">
        <!-- dropdown start -->

        <div class="dropdown dropdown-bottom">
            <label tabindex="0" class="btn btn-ghost capitalize font-semibold font-noto-sans gap-2 -mr-4">
        ...
        <div class="flex items-center justify-start">
            <div class="dropdown dropdown-bottom">
                <label tabindex="0" class="btn btn-ghost h-full capitalize font-semibold font-noto-san gap-2 -mr-5 -ml-4">
                    john doe
                    <img src="https://melmagazine.com/wp-content/uploads/2021/01/66f-1.jpg" alt="" class="rounded-full w-[48px] h-[48px]">
                </label>
                <ul tabindex="0" class="dropdown-content p-2  cursor-pointer space-y-2 shadow-elevation-light-4 bg-neutral_600 rounded-lg w-32 text-neutral_050 ">
