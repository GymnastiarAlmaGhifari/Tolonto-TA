                    ...
                    <div class="mt-7">
                        ...
                        <div class="flex flex-col mb-5">
                            <div class="relative z-0 mb-2 w-full group">
                                <input type="text" name="username" id="username" class="block w-full h-[64px] rounded-md bg-neutral_050 text-neutral_900 font-noto-sans outline-none focus:text-base pl-[57px] peer" placeholder=" " required oninput="onFocusUsername()" />
                            ...
                            <div class="relative mt-3 mb-2">
                                <input name="password" type="password" id="password" placeholder=" " required oninput="onFocusPassword()" class="block w-full h-[64px] rounded-md bg-neutral_050 text-neutral_900 font-noto-sans outline-none focus:text-base pl-[57px] peer">
